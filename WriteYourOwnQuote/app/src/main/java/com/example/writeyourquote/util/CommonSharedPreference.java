...
public class CommonSharedPreference {
    ...
    private static CommonSharedPreference sSharedPrefs;


    private CommonSharedPreference(Context context) {
    ...
    public static CommonSharedPreference getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new CommonSharedPreference(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
